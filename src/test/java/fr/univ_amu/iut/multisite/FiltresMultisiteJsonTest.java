...
class FiltresMultisiteJsonTest {
    ...
    void serialise_uniquement_les_criteres_renseignes() {
        ...
        assertThat(FiltresMultisiteJson.serialiser(filtres))
                .isEqualTo("{\"site\":\"640380\",\"statut\":\"Vérifié\",\"verdict\":\"Douteux\",\"annee\":\"2026\"}");
    }
    ...
    void aller_retour_complet() {
        FiltresMultisite filtres = new FiltresMultisite("640380", StatutWorkflow.PRET_A_DEPOSER, Verdict.A_JETER, 2026);
    ...
    void interprete_les_types() {
        FiltresMultisite filtres = FiltresMultisiteJson.interpreter("{\"statut\":\"Importé\",\"annee\":\"2024\"}");
