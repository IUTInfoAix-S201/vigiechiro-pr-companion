...
| **Lot prêt à déposer** | Dossier contenant toutes les séquences d'écoute d'une session d'enregistrement, formaté selon les attentes du portail Vigie-Chiro. | Sous-dossier `transformes/` de la session d'enregistrement (cf. [R22](Règles%20métier.md#r22)), à téléverser tel quel sur vigiechiro.herokuapp.com. |
