...
Le tableau ci-dessous décrit la structure du **full dataset**, conforme à [R22](Analyse%20et%20conception/Modèle%20conceptuel/Règles%20métier.md#r22) ; le sample suit la même arborescence (sans `bruts/` et avec les CSV filtrés).
