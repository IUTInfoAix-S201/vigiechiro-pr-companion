 ...
 *
 * <p>Un code de point vaut <b>exactement 2 caractères : une lettre majuscule suivie d'un
 * chiffre</b> (ex. {@code A1}, {@code Z4}). La validation se fait à la saisie.
 */
public final class ValidateurCodePoint {
  ...
  /** {@code true} si {@code code} est une lettre majuscule suivie d'un chiffre. */
  public static boolean estValide(String code) {
    return code != null && LETTRE_CHIFFRE.matcher(code).matches();
  }

  /**
   * Vérifie {@code code} et le renvoie inchangé, ou lève une {@link IllegalArgumentException} si la
