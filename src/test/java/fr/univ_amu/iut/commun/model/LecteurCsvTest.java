...
class LecteurCsvTest {
    ...
    void lire_format_brut_avec_guillemets() {
        String brut = "\"nom du fichier\";\"tadarida_taxon\";\"tadarida_probabilite\"\n"
                + "\"Car640380-...-000\";\"noise\";\"0.93\"\n";

        List<List<String>> lignes = new LecteurCsv().lire(brut);

        assertThat(lignes).hasSize(2);
        assertThat(lignes.get(0)).containsExactly("nom du fichier", "tadarida_taxon", "tadarida_probabilite");
    ...
    void lire_sans_entete() {
        ...
        assertThat(new LecteurCsv().lireSansEntete(csv)).containsExactly(List.of("v1", "v2"), List.of("v3", "v4"));
    }
