...
**Maquettes cibles** : M-Import (récapitulatif d'inspection du dossier source)<br>
...
**Maquettes cibles** : M-Import (formulaire de rattachement avec auto-incrément du n° de passage)<br>
...
**Maquettes cibles** : M-Import (avec affichage du quadruplet extrait + alerte d'incohérence)<br>
...
**Maquettes cibles** : M-Import (barre de progression et état de la copie)<br>
...
**Parcours rattaché** : [P2](../Parcours%20utilisateurs/P2%20-%20Importer%20une%20nuit%20de%20capture.md), étape 4<br>
**Maquettes cibles** : M-Import (étape de progression « renommage » dans la barre)<br>
...
**Maquettes cibles** : M-Import (barre de progression de la transformation)<br>
...
**Maquettes cibles** : M-Import (combobox avec valeur présélectionnée + indication discrète « dernière association connue pour cet enregistreur »)<br>
...
**Maquettes cibles** : M-Passage (avec action « Modifier le rattachement » et écran de confirmation)<br>
