...
/// la même année.
///
/// Quadruplet `(carré, année, numéro de passage, code point)`. Le site est déduit du point
/// ; la contrainte est matérialisée en base par `UNIQUE(point_id, year, passage_number)`. Ce
...
///
/// @param carre numéro de carré (6 chiffres, cf.
...
/// @param codePoint code du point d'écoute (lettre + chiffre, cf.
