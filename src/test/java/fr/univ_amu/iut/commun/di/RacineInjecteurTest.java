...
/// Test de la racine de composition Guice : vérifie que [RacineInjecteur#creer()] assemble
/// bien **tous** les modules de features (sites, passage, qualification, validation, multisite,
...
///
/// Guice valide les liaisons en double dès la création de l'injecteur : ce test est donc le filet
/// de sécurité qui détecte qu'une future feature ait introduit une liaison concurrente ou oublié
/// son
/// `@Provides`. On surcharge le workspace vers un `@TempDir` (propriété système
