...
class ExportVuCsvTest {
    ...
    private static LigneObservation validee() {
        return new LigneObservation("seq_001", 0.4, 4.8, 45, "Pippip", 0.8, null, "Pippip", 0.8, ModeValidation.MANUEL);
    }
    ...
    void r24_colonne_validation_mode() {
        LigneObservation auto =
                new LigneObservation("seq_003", 0.0, 5.0, 60, "Pippip", 0.7, null, "Pippip", 0.7, ModeValidation.AUTO);
