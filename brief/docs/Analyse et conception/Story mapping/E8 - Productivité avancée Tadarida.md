...
**Maquettes cibles** : M-Vision-Tadarida (variante regroupée), M-MultiSite (action de regroupement)<br>
...
**Maquettes cibles** : M-Vision-Tadarida (bouton « Marquer comme référence »), M-Lot (action « Exporter bibliothèque »)<br>
