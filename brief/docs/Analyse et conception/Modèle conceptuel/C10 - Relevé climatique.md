...
|---|---|---|---|
| chemin sur disque | texte | obligatoire si présent | Fichier `PaRecPR<sn>_THLog.csv` à la racine de la capture (cf. [R22](Règles%20métier.md#r22)). Ex. `PaRecPR1925492_THLog.csv`. |
