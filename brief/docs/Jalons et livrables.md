...
- Le **code métier** : ensemble des classes représentant les entités du domaine cartographiées dans [`Analyse et conception/Modèle conceptuel/`](Analyse%20et%20conception/Modèle%20conceptuel/index.md) (Site de suivi, Point d'écoute, Passage, Capture, Enregistrement original, Séquence d'écoute, Sélection d'écoute, etc.).
