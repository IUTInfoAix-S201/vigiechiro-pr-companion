...
class VerificationCoherenceTest {
    ...
    void preparer() {
        ...
        verification = new VerificationCoherence(
    ...
    private Long creerSession(Long idPassage) {
        return sessionDao
                .insert(new SessionDEnregistrement(
                        null, dossier.resolve(PREFIXE.nomDossierSession()).toString(), null, 4096L, idPassage))
                .id();
    }

    private Long creerOriginal(Long idSession, String nom) {
        return originalDao
                .insert(new EnregistrementOriginal(null, nom, "bruts/" + nom, 12.0, 384000, null, idSession))
                .id();
    }
    ...
    void releve_absent_est_soft() {
        ...
        assertThat(resultat.estBloquant())
                .as("relevé absent = soft, jamais bloquant")
                .isFalse();
