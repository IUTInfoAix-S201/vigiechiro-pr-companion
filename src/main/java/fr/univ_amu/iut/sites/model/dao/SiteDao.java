...
public class SiteDao extends DaoGenerique<Site, Long> {
    ...
    private static final RowMapper<Site> MAPPER = rs -> new Site(
            rs.getLong("id"),
    ...
    public List<Site> findByUtilisateur(String idUtilisateur) {
        return query("SELECT * FROM monitoring_site WHERE user_id = ? ORDER BY square_number", MAPPER, idUtilisateur);
    }
