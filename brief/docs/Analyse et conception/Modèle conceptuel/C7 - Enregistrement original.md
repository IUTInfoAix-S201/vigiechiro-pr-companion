...
| chemin sur disque | texte | obligatoire | Dans le sous-dossier `bruts/` de la capture (cf. [R22](Règles%20métier.md#r22)). |
...
- [R22](Règles%20métier.md#r22) - emplacement sur disque : sous-dossier `bruts/` de la capture.
