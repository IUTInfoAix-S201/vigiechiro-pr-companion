...
flowchart LR
    ...
    subgraph livraison[📤 Dépôt sur Vigie-Chiro]
        direction TB
        Lot[("📦 Dépôt")]
        VC(["🌐 vigiechiro<br/>.herokuapp.com"])
        Lot -.téléversement<br/>par l'application.-> VC
    end
...
Marie clique sur « Vérifier et préparer le dépôt ». L'application vérifie la cohérence du passage (préfixes, complétude des fichiers) puis, **connectée à Vigie-Chiro, téléverse la nuit directement** (elle reprend là où elle s'est arrêtée si la connexion coupe) et **lance la participation**. Sans connexion, Marie peut ouvrir le dossier et déposer depuis son navigateur, puis cliquer « Marquer déposé ».
